...
function MasterNavPanel({ onSelectPage }) {
  ...
  <div className="mnp-logo-left">
    <img 
      src={`${import.meta.env.BASE_URL}PICTURE FILES/hoa-logo.png`}
      alt="HOA-e-Solutions"
    />
  </div>
  ...
  <img
    src={`${import.meta.env.BASE_URL}PICTURE FILES/manage-plus-logo.png`}
    alt="Manage Plus"
  />
  ...
  <img
    ...
    src={`${import.meta.env.BASE_URL}PICTURE FILES/bubble1.png`}
    alt="Information"
  />
      ...
      <section className="mnp-mid" aria-label="Master Navigation Panel Options">
        <div className="left-col">
          <img
  className="house"
  src={`${import.meta.env.BASE_URL}PICTURE FILES/HOUSE.jpg`}
  alt="House"
/>
  ...
  <img
    className="notice notice-left"
    src={`${import.meta.env.BASE_URL}PICTURE FILES/MASTER NAV WARNING 1.png`}
    alt="Confidentiality notice"
  />

  <img
    className="notice notice-right"
    src={`${import.meta.env.BASE_URL}PICTURE FILES/MASTER NAV WARNING 2.png`}
    alt="Program protection warning"
  />
</footer>
    </main>
  )
